...
<<<<<<< HEAD
INSERT INTO `tb_about_us_template` VALUES (1,'哈尔滨市共有教师10万人，中小学学生100万人，目前缺乏有效的沟通桥梁。哈尔滨教育互动平台致力于打造人人乐用的学习服务平台，通过该平台能够高效、智能、精准地匹配师生资源，为老师及学生提供多种增值服务和学习工具，创建一个专业、简单、智能、安全的高品质学习服务的第三方平台，让学习变得更加容易、平等和高效，让所有有知识、技能、才华的人都能够在这个平台上成为老师，让所有需要知识、技能、才华的人都能够在这个平台上找到他们学习的榜样。在让教育问答互动平台成为一种生活方式的同时，教育问答互动平台也在全力打造更富活力、更加健康的教育生态圈。');
=======
...
<<<<<<< HEAD
  `ad_time` datetime DEFAULT NULL COMMENT '发布时间',
=======
...
<<<<<<< HEAD
  `ask_time` datetime DEFAULT NULL COMMENT '追问时间',
=======
...
<<<<<<< HEAD
) ENGINE=InnoDB AUTO_INCREMENT=100000000 DEFAULT CHARSET=utf8 COMMENT='追问表';
=======
...
--
<<<<<<< HEAD
-- Table structure for table `tb_question_content_template`
--

DROP TABLE IF EXISTS `tb_question_content_template`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tb_question_content_template` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `content_id` int(11) unsigned NOT NULL COMMENT '信息ID',
  `content_value` varchar(300) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '' COMMENT '信息内容',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tb_question_content_template`
--

LOCK TABLES `tb_question_content_template` WRITE;
/*!40000 ALTER TABLE `tb_question_content_template` DISABLE KEYS */;
INSERT INTO `tb_question_content_template` VALUES (1,1,'我愿意用真心的感谢换诸位老师一个答案'),(2,2,'各位老师，谁来帮我解答一下这道题，我保证认真学！'),(3,3,'蓦然回首，答案就在灯火阑珊处，老师们帮帮忙~\r\n');
/*!40000 ALTER TABLE `tb_question_content_template` ENABLE KEYS */;
=======
...
<<<<<<< HEAD
-- Dump completed on 2015-08-29 16:17:31
=======
