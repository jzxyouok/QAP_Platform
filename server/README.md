...
>>>>>>> 46917cd49fb2d8e06862c869e0f0c545ca7db35a
			...
			"phone_number": "00000000000",       // 电话号码 (11位)
			"sex": 0,                             // 性别(0: 男 1: 女)
...
修改个人信息(需要修改哪些信息， 就传对应字段的参数)

HTTP POST请求方式, 访问接口: http://123.59.71.144:10100/doUserAct/ModifyPersonalInformation, 请求示例:

	curl -d "username=xxx&nickname=xxx&......" "http://123.59.71.144:10100/doUserAct/ModifyPersonalInformation"

请求参数格式说明:

	{
		"username": "flyfish@ifeiyu.net",                      // 用户名
		"nickname": "张三",              // 昵称 (可选项, 仅当修改此选项, 才需要设置)
		"phone_number": "1111111111",       // 电话号码 (11位, (可选项, 仅当修改此选项, 才需要设置))
		"name": "张三三",                  // 真实姓名 (可选项, 仅当修改此选项, 才需要设置)
		"sex": 1,                        // 性别 (0: 男 1: 女 可选项, 仅当修改此选项, 才需要设置)
		"birthday": "1992-6-9",          // 生日 (可选项, 仅当修改此选项, 才需要设置)
		"address": "北京市",             // 地址 (可选项, 仅当修改此选项, 才需要设置)
		"grade": 1,                    // 年级 (可选项, 仅当修改此选项, 才需要设置)
		"subject": 4,                // 科目 (仅教师有该字段, 可选项, 仅当修改此选项, 才需要设置)
		// 如果是头像
		"avatar_file"
	}
...
返回结果说明:

	{
		...
		// 如果修改的是头像
		"data": {
			"avatar_url": "123.59.71.144/qap_server/uploads/user/avatar/default.png"
		}
		"msg": "修改成功"
	}
...
###23 QueryAskAndAnswerPage
请求用户问题的回答详情页面 (供客户端进入追问追答页面使用)

HTTP POST请求方式, 访问接口: http://123.59.71.144:10100/doQuestionAct/QueryAskAndAnswerPage, 请求示例:

	curl -d "answer_id=xxx" "http://123.59.71.144:10100/doQuestionAct/QueryAskAndAnswerPage"
...
<<<<<<< HEAD
		...
		"data": {
			...
			// 如果是原始问题的回答或者追答 (字段含义如下)
			{
				...
				"answer_sound_url": "xxx",                   // 回答相关的录音url
				"is_accepted": 0,			                  // 是否被采纳
				"type": 0,                  // 类型 (0: 原始问题的回答 1: 追问 2: 追答)
				"answer_time": "2015-08-10 00:13:13"        // 回答的最新时间
				},
				
			   // 如果是原始问题的回答或者追答 (字段含义如下)
			{
				"question_id": 3,                               // 追问产生的临时问题ID
				"answer_id": 1,                                 // 被追问的回答ID
				"answer_username": "flyfish@ifeiyu.net",                // 被追问的用户
				"avatar_url": "123.59.71.144/data/avatars/flyfish.png",     // 追问者的头像索引
				"nickname": "cls1991",                       // 追问者的昵称
				"answer_content": "xxx",                     // 追问内容
				"answer_pic_url": "xxx",                     // 追问相关的图片url
				"answer_sound_url": "xxx",                   // 追问相关的录音url
				"is_accepted": 0,			                  // 是否被采纳(无意义字段, 可忽略)
				"type": 0,                  // 类型 (0: 原始问题的回答 1: 追问 2: 追答)
				"answer_time": "2015-08-10 00:13:13"        // 提问时间
			},
			......
		]
		},
